# User Guide: Extension Officer (County Officer)

This guide explains how to use the platform as an **Extension Officer** (County Officer): viewing dashboards, managing farmers and quality standards, location summaries, reports, aggregation centres, and sending advisories.
...
|---------------------|----------------|
| **My Dashboard**    | Overview of activity and metrics for your area |
| **Farmers**         | View and manage farmers in your area |
| **Quality Standards** | Configure and view quality standards (grades, criteria) |
| **Location Summary** | Sales and activity summary by location |
| **Reports**         | Generate and view reports |
| **Centers**         | View aggregation centres in your area |
| **Advisory**        | Create and send advisories to farmers (SMS and/or web) |
...
2. You see **summary metrics** for your assigned county/sub-county, for example:
   ...
   - **Activity** (e.g. recent sign-ups, orders)
3. Metrics may be shown as cards, numbers, or simple charts. Use this as your **home view** to see how the region is performing. From here you can go to **Farmers**, **Location Summary**, or **Advisory** to drill down or take action.
...
**Essence:** **Location Summary** shows **sales and activity by location** (e.g. ward, sub-county). Use it to compare performance across areas, spot gaps, and plan where to run extension activities or advisories.

**Flow: Open Location Summary → View by ward/sub-county → Compare and plan.**
...
**Essence:** **Reports** let you **generate and view** structured reports (e.g. farmer activity, sales by location, adoption). Use them for planning, reporting to supervisors, and evidence-based decisions.

**Flow: Open Reports → Select report type → Generate or view → Export/print if needed.**

1. Go to **Reports** in the sidebar.
2. You see options to **generate or view** reports. Common types:
   - **Farmer activity** (e.g. registrations, listings per farmer)
...
**Essence:** **Centers** shows **aggregation centres** in your area—where farmers deliver and where buyers are served. Use it to know the physical network and to direct farmers or advise on collection points.

**Flow: Open Centers → View list of centres → Use for reference when advising farmers.**
...
1. Go to **Advisory** in the sidebar.
2. You see **past advisories** in a list: title, date sent, **notifications sent** (how many were sent), **SMS delivered** (if DLR is configured), **read** count. Open one to review content and reach.
3. To send a **new advisory**, click **Create** or **Send advisory**.
4. In the form, enter:
   - **Title** (short headline for the message)
   - **Content** (the main message to farmers—keep it clear and concise for SMS length if needed)
   - **Target audience**: choose one of:
     - **All** (all farmers on the platform)
     - **Sub-county** (then enter or select sub-county name)
     - **Farmer group** (then enter or select group code or name)
     - **Individual** (then enter phone or select farmer(s))
   - Optional: **type**, **category**, or **priority** if the form supports them.
5. Click **Send**. The platform sends the advisory via **SMS** (to phones) and **web push** (to users who have allowed notifications). Farmers receive it on their phone and/or in the app; **read** counts may update when they open it.
6. After sending, the new advisory appears in the list with **notifications sent**, **SMS delivered** (if configured), and **read** counts so you can see reach and engagement.
...
| Goal | Steps |
|------|--------|
| See area overview | My Dashboard → View metrics and cards |
| Support farmers | Farmers → Filter by location → Open farmer → View profile, listings, orders |
| Set quality rules | Quality Standards → View/edit grade criteria → Save |
| Compare locations | Location Summary → View by ward/sub-county → Compare and plan |
