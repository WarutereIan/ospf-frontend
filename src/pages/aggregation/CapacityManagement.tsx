    ...
    setTimeout(() => {
      const sampleData: CapacityData[] = [
        ...
        },
        {
          ...
          status: "full",
          varietyBreakdown: [
            { variety: "Kenya", quantity: 5000, percentage: 45.5 },
            { variety: "SPK004", quantity: 4000, percentage: 36.4 },
            { variety: "Kabode", quantity: 2000, percentage: 18.1 },
          ],
        },
        {
          centerId: "C004",
          centerName: "Yatta Aggregation Center",
          totalCapacity: 9000,
          currentStock: 1800,
          utilization: 20,
          availableSpace: 7200,
          status: "low",
          varietyBreakdown: [
            { variety: "Kenya", quantity: 1000, percentage: 55.6 },
            { variety: "SPK004", quantity: 500, percentage: 27.8 },
            { variety: "Kabode", quantity: 300, percentage: 16.6 },
          ],
        },
      ];
